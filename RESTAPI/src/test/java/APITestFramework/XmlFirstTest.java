...
public class XmlFirstTest {
  ...
  public void deleteTest()
  {
	  ...
	  Response res=given().
	  queryParam("key",prop.getProperty("KEY"))
	  .body(ApiPayLoad.getDeletePlaceBodyXml(placeID))
	  .when().post(ApiResources.deletePlaceResXml())
	  .then().assertThat().statusCode(200).and().contentType(ContentType.XML)
	  .extract().response();
